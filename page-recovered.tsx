  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-grow">
            ...
            {mounted && floatingSubjects.map((subject, i) => (
              ...
              >
                ...
                `}>
                  ...
                  {/* Hover Reveal Topics */}
                  <div className="absolute top-full left-1/2 -translate-x-1/2 mt-3 w-52 bg-card border border-border rounded-2xl p-4 opacity-0 scale-95 pointer-events-none group-hover:opacity-100 group-hover:scale-100 group-hover:pointer-events-auto transition-all duration-300 shadow-xl">
        ...
        <motion.section style={{ opacity: gridOpacity, y: gridY }} className="pt-40 pb-32 px-8 max-w-7xl mx-auto relative z-30 bg-background">
              ...
              {[
                ...
                <div key={pIdx} className="flex flex-col group/path">
                  ...
                  <div className="relative pl-8">
                    ...
                    <div className="absolute left-[11px] top-6 bottom-6 w-[2px] bg-border group-hover/path:bg-primary/20 transition-colors duration-500"></div>
                    
                    <div className="flex flex-col gap-8">
                      {path.steps.map((step, i) => (
                        <div key={step} className="relative flex items-center group cursor-pointer">
                          {/* Timeline Dot */}
                          <div className="absolute -left-[35px] w-6 h-6 rounded-full bg-card border-2 border-border group-hover:border-primary group-hover:bg-primary/10 transition-colors z-10 flex items-center justify-center">
        ...
        {/* Added massive top and bottom margins for breathing room */}
        <section className="my-20 py-40 bg-foreground text-card border-y border-foreground overflow-hidden">
          <div className="max-w-7xl mx-auto px-8">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-12 text-center md:text-left md:divide-x md:divide-border/20">
        ...
        {/* SECTION 10: Quotes */}
        <section className="py-48 px-8 flex items-center justify-center text-center max-w-5xl mx-auto">
      ...
      <footer className="bg-card border-t border-border pt-32 pb-16 px-8">
