...
import { 
  ...
  Bell, Search, Flame, Menu, X, BookOpen 
} from "lucide-react";
...
const SECONDARY_LINKS = [
  { name: "Quizzes", href: "#", icon: FileQuestion },
  { name: "Flashcards", href: "#", icon: Layers },
  { name: "Study Planner", href: "#", icon: Calendar },
      ...
      <div className="flex-1 md:ml-[280px] flex flex-col min-h-screen">
        ...
        <header className="h-20 bg-background/80 backdrop-blur-md border-b border-border sticky top-0 z-30 flex items-center justify-between px-4 sm:px-8">
          ...
          <div className="flex items-center gap-3 sm:gap-6">
            ...
            <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-subject-math to-subject-science cursor-pointer" />
          </div>
        </header>
