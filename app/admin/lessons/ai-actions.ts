...
4. Localize Context: Where examples are needed to explain a concept, invent completely new, original examples. IF the Target Audience is "Nigerian Senior Highschool", "Nigerian Junior School", "Nigerian Primary School", or "Nigerian University", use localized Nigerian markets, names, or relatable African scenarios. For all other audiences, keep examples general. **CRITICAL EXCEPTION:** If the topic is strict historical fact, universal scientific principles, advanced mathematics, or global concepts where localizing would be forced or inaccurate, DO NOT localize it. Retain standard universal examples or what was in the reference text. Only make examples localized if it naturally aids comprehension without distorting facts.
